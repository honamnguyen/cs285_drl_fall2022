...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        # TODO(Q1) compute delta_pred_normalized and next_obs_pred (DONE)
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        """
        # TODO(Q1) get the predicted next-states (s_t+1) as a numpy array (DONE)
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        :return:
        """
        # TODO(Q1) compute the normalized target for the model. (DONE)
        ...
        loss = self.loss(ptu.from_numpy(target), delta_pred_normalized)
